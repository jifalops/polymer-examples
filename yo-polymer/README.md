*Generated from `yo polymer` using [generator-polymer](https://github.com/yeoman/generator-polymer) version 1.2.10 and includes web-components-tester and recipe docs.*
